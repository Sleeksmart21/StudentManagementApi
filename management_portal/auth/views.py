...
class SignUp(Resource):
    def get(self):
        return {"message": "Hello auth, I am Ready"}
...
signup_model = auth_namespace.model(
    'SignUp', {
        ...
        'password_reset_token': fields.String(required=True, description='A password reset token')
    }
)
...
users_model = auth_namespace.model(
    'User', {
        'id': fields.Integer(),
        'identifier': fields.String(required=False, description='User identifier'),
        'first_name': fields.String(required=True, description="A username"),
        'last_name': fields.String(required=True, description="A username"),
        'email': fields.String(required=True, description="An email"),
...
class SignUp(Resource):
    ...
    @auth_namespace.expect(users_model)
    @auth_namespace.marshal_with(users_model)
    def post(self):
        """
            Sign up a user
        """
